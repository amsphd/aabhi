...
fishfiles <- list.files(path="./Fish", pattern="Copy of Fish8.1(a|b)_AA(_?)(R?)(\\d\\d\\d)$", full.names=F, recursive=FALSE)
Qfiles <- list.files(path="./Quarters", pattern="Copy of QuartersFortune1.4(a|b)_AA(_?)(R?)(\\d\\d\\d)$", full.names=F, recursive=FALSE)
chofiles <- list.files(path="./Choose", pattern="Copy of Choose32.1_AA(_?)(R?)(\\d\\d\\d)$", full.names=F, recursive=FALSE)
...
partcodes1 <- sub("Copy of Fish8.1(a|b)_AA(_?)(R?\\d\\d\\d)$","\\3",fishfiles,perl=TRUE)
partcodes2 <- sub("Copy of QuartersFortune1.4(a|b)_AA(_?)(R?\\d\\d\\d)$","\\3",Qfiles,perl=TRUE)
partcodes3 <- sub("Copy of Choose32.1_AA(_?)(R?\\d\\d\\d)$","\\2",chofiles,perl=TRUE)
...
save(participants,file="Y3Q1_PreliminaryExercise.Rdata")

#write.table(participants,"Y1_PreliminaryExercise.txt",sep="\t")
write.csv(participants,file = "Y3Q1_PreliminaryExercise.csv")
