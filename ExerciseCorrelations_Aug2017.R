...
data=read.csv("ExercisePreliminary_Y2Q4_full_2.csv")
summary(data)
View(data)
str(data)
...
pdf("Y2Q4_Neuropsych_Exercisers_exploratory.pdf",height=7,width=8)
my.pairscor(ExInt[,c(4:6,10,11,12:14,19,3)])
dev.off()

pdf("Y2Q4_H+L_Exercisers_exploratory.pdf",height=7,width=8)
my.pairscor(ExInt[,c(20:22,25,34:35,38:42,3)])
dev.off()

pdf("Y2Q4_Fitness_Exercisers_exploratory.pdf",height=7,width=8)
my.pairscor(ExInt[,c(48:55,68,3)])
dev.off()

pdf("Y2Q4_Cognitive_Exercisers_exploratory.pdf",height=7,width=8)
...
#Neuropsych
pdf("Y2Q4_Neuropsych_2_Exercisers.pdf",height=7,width=8)
my.pairscor(ExInt[,c(4:6,10,11,12:14,19,3)])
dev.off()

pdf("Y2Q4_Neuropsych_2_Controls.pdf",height=7,width=8)
...
pdf("Y2Q4_H+L_Exercisers.pdf",height=7,width=8)
my.pairscor(ExInt[,c(20:22,25,34:35,38:42,3)])
dev.off()

pdf("Y2Q4_H+L_Controls.pdf",height=7,width=8)
...
## Fitness
pdf("Y2Q4_Fitness_Exercisers.pdf",height=7,width=8)
my.pairscor(ExInt[,c(48:68,3)])
dev.off()

pdf("Y2Q4_Fitness_Controls.pdf",height=7,width=8)
my.pairscor(CtrlInt[,c(48:68,3)])
dev.off()

## Cognitive
pdf("Y2Q4_Cognitive_Exercisers.pdf",height=7,width=8)
my.pairscor(ExInt[,c(69:76,3)])
dev.off()

pdf("Y2Q4_Cognitive_Controls.pdf",height=7,width=8)
